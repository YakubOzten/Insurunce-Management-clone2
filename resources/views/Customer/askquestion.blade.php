...
<div class="container-fluid">
    <h4 style="color: #FFFFFF">Sigorta Teklifi Almak için Seçin:</h4>
                ...
                <form action="{{route('create-question')}}" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"> Kasko
                            Teklifi  Almak için doldurun</h5>
                ...
                <form action="{{route('create-question')}}" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel2"> Sağlık
                            Sigortası Teklifi Almak için doldurun </h5>
                        <button type="button" class="close" data-dismiss="modal"
                                aria-label="Close">&times;
                        </button>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{route('create-question')}}" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel4"> Zorunlu Deprem Sigortası(DASK)
                            Teklifi Almak için doldurun</h5>
                        <button type="button" class="close" data-dismiss="modal"
                                aria-label="Close">&times;
                        </button>
                        ...
                        <div class="form-validation">
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="col-lg-9">
                                            <textarea rows="4" cols="50" maxlength="200" required
