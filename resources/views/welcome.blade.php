            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-lg-auto text-center">
                    ...
                    <li class="nav-item  mr-lg-3 mt-lg-0 mt-3">
                        <a class="nav-link scroll" href="#about">hakkında</a>
                    </li>
    ...
    <div class="container">
        <div class="banner-text">
            <div class="slider-info">
                <h3>AİLENİZİ SİGORTA İLE KORUYUN</h3>
                {{--                <p class="text-white mt-sm-4 mt-2">Rutrum congue donec leo eget malesuada ras ultricies ligula sed magna--}}
                {{--                    dictum porta.</p>--}}
                <a class="btn btn-primary mt-4 agile-link-bnr scroll" href="#about" role="button">DAHA FAZLA GÖSTER</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="abt-block mb-lg-0 mb-5">
                        ...
                        <p>ister ev sahibi olun ister kiracı, siz de “Evim gibisi yok!” diyenlerdenseniz; bütçenize ve ihtiyacınıza en uygun Konut Sigortası ile evinizi ve evinizi paylaştığınız sevdiklerinizi güvence altına alın, huzuru ve mutluluğu yakalayın.
                ...
                <div class="col-lg-4 my-lg-0 my-md-5">
                    <div class="abt-block">
                        ...
                        <p>Trafik Sigortası, aracınızla gerçekleştirebileceğiniz bir kaza sonucunda diğer araçlara veya üçüncü şahıslara verebileceğiniz zararlar için sizi teminat altına alan zorunlu bir sigortadır.</p>
                    </div>
                </div>
                <div class="col-lg-4 mt-lg-0 mt-md-5">
                    <div class="abt-block mt-md-0 mt-5">
                        <div class="serv_abs serv_bottom">
                            <i class="fa-sharp fa-solid fa-car-burst"></i>
                        </div>
                        <h3>Araç Kasko </h3>
                        <p>Aracını kaza ve arıza durumlarına karşı güvence altına alan kasko, bu sayede seni beklenmedik masraflara karşı koruyor. Kasko sigortaları; genişletilmiş kasko, tam kasko gibi türlere ayrılıyor ve araç sahiplerine benzersiz avantajlar sunuyor.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 my-lg-0 my-md-5">
                            <div class="abt-block">
                                ...
                                <h3>Sağlik Sigortası</h3>
                                <p>Bireysel Sağlık Sigortası, dilediğiniz doktor ya da sağlık kurumunu seçme özgürlüğü sağlar. Kaza ya da hastalık sonucu ortaya çıkan ayakta ya da yatarak teşhis ve tedavilere ait masraflar, yurtiçinde veya dünyanın neresinde olursanız olsun karşılanır.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-lg-0 mt-5">
                            <div class="abt-block">
                                ...
                                <p>Zorunlu Deprem Sigortası, evinizi depremin neden olabileceği maddi hasarlara karşı güvence altına alan ve teminatı Doğal Afet Sigortaları Kurumu (DASK) tarafından verilen yaptırılması zorunlu bir sigortadır.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="contact-wthree" id="contact">
    <div class="container py-sm-5">
        <div class="title-section py-4">
            <h3 class="main-title-agile">Bizimle İletişime Geçin</h3>
            <span class="title-line">
                </span>
        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="text" placeholder="xxx xxx xx xx" name="mobile"
                                           required="">
                                </div>
                                <div class="col-md-6 mt-md-0 mt-4">
                                    <label>
                                    ...
                                    <input class="form-control" type="email" placeholder="ornek@email.com" name="email"
                                           required="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea placeholder="Mesajınızı buraya yazın" name="message" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-agile btn-block w-100 font-weight-bold text-uppercase">Gönder</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    <div class="form-group">
                        <label for="id=email" name="email" value="{{ __('Email') }}" class="col-form-label">Kullanıcı Adı</label>
                        <input type="text" class="form-control" placeholder=" " name="email":value="old('email')" id="email"
                               required="">
                    </div>
                    <div class="form-group">
                        <label for="password" class="col-form-label">Sifre:</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('register') }}">
                    @csrf
                    <div class="form-group">
                        <label for="name" value="{{ __('Name') }}" class="col-form-label">Kullanıcı Adı</label>
                        <input type="text" class="form-control" placeholder=" " name="name" :value="old('name')" id="name"
                               required="">
                    </div>
                    <div class="form-group">
                        <label for="email" value="{{ __('Email') }}" class="col-form-label">E-mail</label>
                        <input type="email" class="form-control" placeholder=" " name="email" :value="old('email')"  id="email"
                               required="">
                    </div>
                    <div class="form-group">
                        <label for="password" value="{{ __('Password') }}" class="col-form-label">Sifre</label>
                        <input type="password" class="form-control" placeholder=" " name="password" id="password"
                               required="">
                    </div>
                    <div class="form-group">
                        <label for="password_confirmation" class="text-white" value="{{ __('Confirm Password') }}">Şifreyi Onayla</label>
