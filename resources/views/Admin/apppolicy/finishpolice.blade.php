        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-striped" style="width:100%;">
                ...
                @foreach($pols as $item)
                    <tr>
                        <input type="hidden" class="app2delete_val_id" value="{{$item->id}}">
                        @if($item->status == '1')
                            ...
                            <td>
                                <button class="btn btn-danger app2deletebtn"> <i class="fa fa-trash"></i>SİL</button>
...
<script>
    $(document).ready(function () {
        $('.app2deletebtn').click(function (e) {
            e.preventDefault();
            var delete_id = $(this).closest("tr").find('.app2delete_val_id').val();
